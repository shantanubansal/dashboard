...
import (
	...
	"github.com/shantanubansal/dashboard/src/app/backend/cert"
	...
	"github.com/shantanubansal/dashboard/src/app/backend/handler"
...
func init() {
	os.Setenv("KUBECONFIG", "/Users/shantanu/.kube/config")
}
...
var (
	...
	argKubeConfigFile            = pflag.String("kubeconfig", "/Users/shantanu/.kube/config", "path to kubeconfig file with authorization and master location information")
...
func handleFatalInitError(err error) {
	log.Fatalf("Error while initializing connection to Kubernetes apiserver. "+
		...
		"https://github.com/shantanubansal/dashboard/wiki/FAQ", err)
}
